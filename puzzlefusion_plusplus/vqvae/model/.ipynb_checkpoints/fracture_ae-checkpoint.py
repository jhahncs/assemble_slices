...
class FractureAE(pl.LightningModule):
    ...
    def forward(self, data_dict):
        ...
        #print(part_pcs.shape)
        #print(num_parts)
        B, N, _, _ = part_pcs.shape # B = the number of instances, N = max number of parts

        range_tensor = torch.arange(N).unsqueeze(0).expand(B, -1).to(part_pcs.device)
        #print(range_tensor)
        #print(num_parts.unsqueeze(1))
        ...
        #print('output_dict')
        #print('xyz')
        #print(output_dict['xyz'].shape)
        #print('z_q')
        #print(output_dict['z_q'].shape)
