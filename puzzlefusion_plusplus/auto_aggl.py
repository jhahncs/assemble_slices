...
class AutoAgglomerative(pl.LightningModule):
    ...
    def test_step(self, data_dict, idx):        
        ...
        for iter in range(self.cfg.verifier.max_iters):
            ...
            print(data_dict["mesh_file_path"] )
            print(data_dict["num_parts"] )
            print(data_dict["data_id"] ) 
            print('part_scale',part_scale.shape,part_scale)
            
            print('edge_features',edge_features.shape,edge_features)
            ...
            print('classified_part',classified_part.shape,classified_part)
            print('larger_parts',larger_parts.shape,larger_parts)
